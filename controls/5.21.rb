...
control 'C-5.21' do
  ...
  describe 'Requires manual review and attestation' do
    skip "Requires manual review and attestation provided for this control (host UTS namespace sharing is detectable from task-definition --uts=host; not visible from inside the container)"
  end
end
