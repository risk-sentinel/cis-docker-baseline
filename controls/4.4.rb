...
control 'C-4.4' do
  ...
  describe 'Requires manual review and attestation' do
    skip "Requires manual review and attestation provided for this control (image scanning + rebuild cadence is a CI/CD pipeline concern (ECR scan, Trivy, Snyk, etc.) — operators attest from their pipeline scan results)"
  end
end
