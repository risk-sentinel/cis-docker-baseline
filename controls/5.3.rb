...
control 'C-5.3' do
  ...
  describe 'Requires manual review and attestation' do
    skip "Requires manual review and attestation provided for this control (SELinux is not used on Fargate (AppArmor is the default LSM); host_daemon SELinux-enabled consumers attest from their security-options config)"
  end
end
