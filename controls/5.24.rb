...
control 'C-5.24' do
  ...
  describe 'Requires manual review and attestation' do
    skip "Requires manual review and attestation provided for this control (docker exec --user=root usage is observable only from daemon audit logs; operators attest from CloudTrail ECS exec-command audit events)"
  end
end
