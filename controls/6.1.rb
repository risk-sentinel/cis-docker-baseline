...
control 'C-6.1' do
  ...
  describe 'Requires manual review and attestation' do
    skip "Requires manual review and attestation provided for this control (image sprawl avoidance is an operational hygiene control (regular `docker image prune`, ECR lifecycle policies, etc.) — operators attest from their image-cleanup process)"
  end
end
