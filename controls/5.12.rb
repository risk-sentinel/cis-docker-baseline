...
control 'C-5.12' do
  ...
  describe 'Requires manual review and attestation' do
    skip "Requires manual review and attestation provided for this control (\"appropriate\" CPU priority depends on the workload mix and capacity-planning record; operators cross-reference task-definition cpu reservations)"
  end
end
