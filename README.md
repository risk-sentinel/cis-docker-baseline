...
curl -LO https://github.com/risk-sentinel/cis-docker-baseline/releases/download/$VERSION/cis-docker-v1.8.0-$VERSION.tar.gz

# then, on the isolated side
mkdir -p cis-docker-v1.8.0 && tar xzf cis-docker-v1.8.0-$VERSION.tar.gz -C cis-docker-v1.8.0
cd cis-docker-v1.8.0
...
```yaml
uses: risk-sentinel/cis-docker-baseline/.github/workflows/exec-evidence.yml@<version>
with:
  profile_source: archive
  archive_path: ./cis-docker-v1.8.0-<version>.tar.gz
```
...
```yaml
include:
  - project: <your-org>/cis-docker-baseline
    ref: <version>
