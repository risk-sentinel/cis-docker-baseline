...
## container_only mode (managed container runtime, e.g. AWS Fargate)
...
host_daemon surface is for consumers running their own dockerd; it carries no
risk to the container_only path in the interim.
